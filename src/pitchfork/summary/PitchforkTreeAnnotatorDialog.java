...
public class PitchforkTreeAnnotatorDialog {
    ...
    private JComboBox<PitchforkTreeAnnotator.Target> summaryTreeCombo = new JComboBox<>(PitchforkTreeAnnotator.Target.values());

    private JComboBox<PitchforkTreeAnnotator.HeightsSummary> nodeHeightsCombo = new JComboBox<>(PitchforkTreeAnnotator.HeightsSummary.values());
	...
	public PitchforkTreeAnnotatorDialog(final JFrame frame) {
		this.frame = frame;
	...
	public boolean showDialog(String title) {
		...
		JOptionPane optionPane = new JOptionPane(optionPanel,
				...
				new String[] { "Run", "Quit" },
				null);
		optionPane.setBorder(new EmptyBorder(11, 12, 12, 12));
    ...
    public PitchforkTreeAnnotator.Target getTargetOption() {
        return (PitchforkTreeAnnotator.Target)summaryTreeCombo.getSelectedItem();
    }

    public PitchforkTreeAnnotator.HeightsSummary getHeightsOption() {
        return (PitchforkTreeAnnotator.HeightsSummary)nodeHeightsCombo.getSelectedItem();
    }
