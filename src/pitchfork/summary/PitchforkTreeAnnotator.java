...
//    }
    ...
    public static void printTitle() {
        progressStream.println();
        centreLine("PitchforkTreeAnnotator", 60);
        progressStream.println();
        progressStream.println();
    }
    ...
    public static void printUsage(Arguments arguments) {
        ...
        arguments.printUsage("ptannotator", "<input-file-name> [<output-file-name>]");
        progressStream.println();
        progressStream.println("  Example: ptannotator test.trees out.txt");
        progressStream.println("  Example: ptannotator -burnin 10 -heights mean test.trees out.txt");
        progressStream.println("  Example: ptannotator -burnin 20 -target map.tree test.trees out.txt");
        progressStream.println();
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length == 0) {
            ...
            String nameString = "PitchforkTreeAnnotator " + versionString;
            ...
            PitchforkTreeAnnotatorDialog dialog = new PitchforkTreeAnnotatorDialog(new JFrame());

            if (!dialog.showDialog("PitchforkTreeAnnotator ")) {
                return;
            }
            ...
            try {
                new PitchforkTreeAnnotator(burninPercentage,
                		lowMem,
                        heightsOption,
                        posteriorLimit,
                        hpd2D,
        ...
        try {
        	new PitchforkTreeAnnotator(burnin, lowMem, heights, posteriorLimit, hpd2D, target, targetTreeFileName, inputFileName, outputFileName);
        } catch (IOException e) {
        	throw e;
        } catch (Exception e) {
			e.printStackTrace();
